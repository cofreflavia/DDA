/**
 * Escribir en Java una clase TestConjunto para probar todos los
 * métodosimplementados.
 */
package trabajoPractN3.test;

import trabajoPractN3.clases.Conjunto;
...
public class TestConjunto {
    ...
    public static void main(String[] args) {
        ...
        // Comprobar si el conjunto está vacío          System.out.println("A está vacío? " + a.estaVacio()); 
