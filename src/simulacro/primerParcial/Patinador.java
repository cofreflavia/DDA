 ...
 * las siguientes categorías: A, B, C, I (intermedia) y P (principiante). Los
 * datos de los patinadores están almacenados en un arreglo de Patinador. Se
 * debe implementar la clase Patinador especificada en el UML y un programa que
 * permita implementar el TDA Patinador con la definición de los atributos y la
 * implementación de los siguientes métodos: constructores, una operación
