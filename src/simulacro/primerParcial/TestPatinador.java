/**
 * Implementar la clase TestPatinador que a través de un menú de opciones
 * permita: a) Carga los datos de los patinadores. El arreglo será dimensionado
 * con un valor ingresado por el usuario, ya que la cantidad de participantes
 * del evento es conocida. b) Mostrar por pantalla los datos de todos los
 * patinadores que pertenecen a una categoría dada. c) Dado el documento de un
 * patinador, cambiar su categoría de la siguiente manera: iniciando en
 * categoría P: P -> I -> C -> B -> A. Un patinador de categoría A no puede
 * aumentar su categoría, por lo tanto mantiene la categoría A. Este método debe
 * usar asciendeCategoria() de Patinador.
 */
package simulacro.primerParcial;
