/**
 * En una provincia se están cambiando los números de teléfonos celulares de 8
 * dígitos de la siguiente manera: luego del 15 se agrega un 4, los 3 números
 ...
 * 
* IMPORTANTE: La cadena de caracteres de entrada siempre tendrá una secuencia
 * de dígitos que representa un número de celular, es decir que no posee
 * espacios en blanco, ni caracteres especiales, y la longitud de la cadena de
 * entrada es siempre 8.
 */
