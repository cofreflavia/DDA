...
public class TestPersona {
    ...
    public static void menu() {
        ...
        System.out.println("      1 Generar un elemento del arreglo de persona                    |");
        System.out.println("      2 Generar arreglo de personas aleatorios.                       |");
        System.out.println("      3 Mostrar el arreglo de personas.                               |");
        System.out.println("      4 Buscar persona segun el apellido.                             |");
        System.out.println("Segun CUIT-CUIL ordenar arreglo utilizando:                           |");
        System.out.println("      5  INSERTION-SORT.                                              |");
        System.out.println("      6  SELECTION-SORT.                                              |");
        System.out.println("      7  BURBUJA-SORT.                                                |");
        System.out.println("      8  MERGE-SORT.                                                  |");
        System.out.println("      9  QUICK-SORT.                                                  |");
        System.out.println("      10 HEAP-SORT.                                                   |");
        System.out.println("Buscar un CUIT-CUIL con:                                              |");
        System.out.println("      11 BUSQUEDA-SECUENCIAL.                                         |");
        System.out.println("      12 BUSQUEDA-BINARIA                                             |");
        System.out.println("                                                                      |");
        System.out.println("      13 Mostrar personas físicas segun código postal.                |");
        System.out.println("      14 Mostrar personas jurídicas segun código postal y calle.      |");
        System.out.println("      15 Cantidad de personas físicas con el mismo apellido.          |");
        System.out.println("      16 Cantidad de personas jurídicas en una misma provincia.       |");
        System.out.println("                                                                      |");
